...
int main(void) 
{
    printf("Los primeros 500 numeros primos\n");

 for(int numero = 0; numero < 3600; numero++)//Funcion que recorre los numeros del 0 al 3600 para asi obtener los 500 numeros primos
 {
if (esPrimo(numero)) //Basado en el metodo esprimo, si el metodo es primo retorna 1 significa que el numero era primo
  {
    printf(" %d ",numero);//Solamente se imprime si es primo
  } 
  }
  return 0;
}
